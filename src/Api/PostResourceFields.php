 ...
 * and the response carries the post back with its new totals, so the client
...
class PostResourceFields
{
    ...
    public function __invoke(): array
    {
        return [
             ...
             *
             * What the actor voted is served on the discussion as
             * `warrenUserVote`, loaded in bulk for the whole page. A readable
             * field here would be a second, per-post source for the same fact,
             * and the two would answer differently the moment one of them was
             * loaded and the other was not.
             */
